...
sudo docker run --network=bridge --add-host=host.docker.internal:host-gateway -e VITE_API_BASE_URL=http://34.173.97.175:8000 -p 80:8080 --name neural-needledrop-ui-container -d us-central1-docker.pkg.dev/neural-needledrop/neural-needledrop-webapp/neural-needledrop-ui:latest
