...
sudo docker run -e POSTGRES_HOST=neural-needledrop-database -e OPENAI_API_KEY=$OPENAI_API_KEY -p 8000:8000 us-central1-docker.pkg.dev/neural-needledrop/neural-needledrop-webapp/neural-needledrop-api:latest
